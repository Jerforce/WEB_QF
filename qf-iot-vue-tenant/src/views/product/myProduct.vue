<template>
    <div class="app-container">
        ...
        <div class="app-container">
            <el-button type="primary" style="margin: 20px, 20px;" @click="addProduct">创建产品</el-button>
            ...
            <el-table :data="productList" style="width: 100%">
                ...
                <el-table-column label="操作" header-align="center" align="center">
                    <template slot-scope="scope">
                        ...
                        <!-- <el-button @click="open(scope.row.id)" type="danger" style="margin-left: 16px;">
                            删除
                        </el-button> -->
                    </template>
                </el-table-column>
...
<script>
import { myProduct, detail, del } from '@/api/product'
...
export default {
    ...
    methods: {
        ...
        search() {
            myProduct(this.pageDto).then(res => {
