    ...
    <div class="app-container">
        ...
        <el-table :data="tenantList" style="width: 100%">
            ...
            <el-table-column prop="accessKey" label="操作">
                <template slot-scope="scope">
                    <el-button @click="upd(scope.row,1)" type="text" size="small">通过</el-button>
                    <el-button @click="upd(scope.row,2)" type="text" size="small" style="color: red;">不通过</el-button>
                </template>
            </el-table-column>
...
<script>
    //导入dept api
    import { page,update } from "@/api/tenantverify";
    //导入pcd组件
